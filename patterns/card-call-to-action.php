 ...
 * Slug: auctor/card-call-to-action
 * Description:
 * Categories: auctor/card, auctor/call-to-action
...
<p class="has-base-color has-text-color has-medium-font-size" style="font-style:normal;font-weight:600">Get Auctor</p>
<!-- /wp:paragraph -->
...
<p class="has-base-color has-text-color">Create stunning websites and digital experiences with the WordPress Site Editor and the Auctor design theme. Perfect for designers, developers, and agencies. Anyone can do it!</p>
<!-- /wp:paragraph -->

<!-- wp:buttons -->
<div class="wp-block-buttons"><!-- wp:button {"width":100,"className":"is-style-button-light"} -->
<div class="wp-block-button has-custom-width wp-block-button__width-100 is-style-button-light"><a class="wp-block-button__link wp-element-button" href="https://imagewize.com/auctor">Get Started</a></div>
<!-- /wp:button --></div>
<!-- /wp:buttons -->
...
<p class="has-text-align-center has-primary-accent-color has-text-color has-link-color has-x-small-font-size"><a href="#">or view on WordPress.org</a></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:group -->
