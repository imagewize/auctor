...
<p class="has-text-align-center has-medium-font-size" style="font-style:normal;font-weight:600">Build With Patterns</p>
<!-- /wp:paragraph -->

<!-- wp:paragraph {"align":"center","textColor":"primary-accent"} -->
<p class="has-text-align-center has-primary-accent-color has-text-color">Build your blazing fast website with the power of the WordPress Site Editor and beautiful, pre-made pattern designs from Moiraine. No coding skills required.</p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
...
<div class="wp-block-button is-style-fill"><a class="wp-block-button__link wp-element-button">Explore Features</a></div>
<!-- /wp:button --></div>
<!-- /wp:buttons --></div>
<!-- /wp:group -->
