 ...
 * Slug: auctor/call-to-action-card-with-buttons
 * Description: A call to action with text and a button.
 * Categories: auctor/call-to-action, auctor/card
...
<p class="has-text-align-center has-medium-font-size" style="font-style:normal;font-weight:600">Publish With Style</p>
<!-- /wp:paragraph -->

<!-- wp:paragraph {"align":"center","textColor":"primary-accent"} -->
<p class="has-text-align-center has-primary-accent-color has-text-color">Create engaging publications with the WordPress Site Editor and beautiful, pre-designed patterns from Auctor. Perfect for writers, editors, and content creators.</p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
...
<div class="wp-block-button is-style-button-light"><a class="wp-block-button__link wp-element-button">Start Writing</a></div>
<!-- /wp:button -->

<!-- wp:button {"className":"is-style-fill"} -->
<div class="wp-block-button is-style-fill"><a class="wp-block-button__link wp-element-button">Browse Layouts</a></div>
<!-- /wp:button --></div>
<!-- /wp:buttons --></div>
<!-- /wp:group -->
