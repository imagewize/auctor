 ...
 * Slug: auctor/header-light-with-banner
...
<header class="wp-block-group alignfull"><!-- wp:group {"metadata":{"name":"CTA Bar"},"align":"full","style":{"spacing":{"padding":{"top":"var:preset|spacing|small","right":"var:preset|spacing|medium","bottom":"var:preset|spacing|small","left":"var:preset|spacing|medium"}}},"textColor":"base","gradient":"purple","layout":{"type":"constrained"}} -->
