...
<div class="wp-block-button is-style-secondary-button"><a class="wp-block-button__link has-border-color has-tertiary-border-color wp-element-button">Browse Templates</a></div>
<!-- /wp:button --></div>
<!-- /wp:buttons --></section>
<!-- /wp:group -->
