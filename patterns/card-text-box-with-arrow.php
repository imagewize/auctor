...
/**
 * Title: Text Box Card
 * Slug: auctor/text-box-with-arrow-card
 * Description:
...
<p class="has-medium-font-size" style="font-style:normal;font-weight:600">Post Page</p>
<!-- /wp:paragraph -->

<!-- wp:paragraph {"textColor":"secondary"} -->
<p class="has-secondary-color has-text-color">Add your splash of colors, pick your header, choose your favorite font — all with a few quick clicks. No coding skills required.</p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
...
<p class="has-primary-color has-text-color has-link-color" style="text-decoration:underline">Read More</p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:group -->
