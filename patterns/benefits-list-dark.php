 ...
 * Slug: auctor/benefits-list-dark
 ...
 */
?>
<!-- wp:group {"metadata":{"name":"Benefits List Dark"},"align":"wide","style":{"spacing":{"padding":{"top":"var:preset|spacing|xxx-large","bottom":"var:preset|spacing|xxx-large"},"margin":{"top":"0","bottom":"0"}}},"backgroundColor":"dark-teal","textColor":"base","layout":{"type":"constrained"}} -->
<div class="wp-block-group alignwide has-dark-teal-background-color has-base-color has-text-color has-background" style="margin-top:0;margin-bottom:0;padding-top:var(--wp--preset--spacing--xxx-large);padding-bottom:var(--wp--preset--spacing--xxx-large)">
    ...
    <div class="wp-block-group alignwide" style="margin-bottom:var(--wp--preset--spacing--x-large)">
        ...
        <div class="wp-block-group">
            <!-- wp:heading {"level":2,"style":{"typography":{"fontSize":"2.5rem","fontWeight":"400"}},"textColor":"base"} -->
            <h2 class="wp-block-heading has-base-color has-text-color" style="font-size:2.5rem;font-weight:400">Why Choose Our Solution</h2>
            <!-- /wp:heading -->
        ...
        <!-- wp:paragraph {"style":{"typography":{"fontSize":"1.1rem","lineHeight":"1.6"}},"textColor":"base"} -->
        <p class="has-base-color has-text-color" style="font-size:1.1rem;line-height:1.6">Discover the key advantages that set us apart and see why thousands of customers trust our platform to deliver exceptional results.</p>
        <!-- /wp:paragraph -->
    </div>
    <!-- /wp:group -->
    ...
    <div class="wp-block-group alignwide">
        ...
        <div class="wp-block-group" style="border-left-color:var(--wp--preset--color--primary);border-left-width:3px;padding-left:var(--wp--preset--spacing--medium)">
            ...
            <p class="has-base-color has-text-color" style="line-height:1.6">Get detailed insights and real-time data visualization that help you make informed decisions and track performance across all key metrics.</p>
            <!-- /wp:paragraph -->
        </div>
        <!-- /wp:group -->
        ...
        <div class="wp-block-group" style="border-left-color:var(--wp--preset--color--primary);border-left-width:3px;padding-left:var(--wp--preset--spacing--medium)">
            ...
            <!-- wp:paragraph {"style":{"typography":{"lineHeight":"1.6"}},"textColor":"base"} -->
            <p class="has-base-color has-text-color" style="line-height:1.6">Minimize operational expenses and prevent costly mistakes with automated processes and intelligent error detection systems.</p>
            <!-- /wp:paragraph -->
        </div>
        <!-- /wp:group -->
        ...
        <div class="wp-block-group" style="border-left-color:var(--wp--preset--color--primary);border-left-width:3px;padding-left:var(--wp--preset--spacing--medium)">
            ...
            <!-- wp:paragraph {"style":{"typography":{"lineHeight":"1.6"}},"textColor":"base"} -->
            <p class="has-base-color has-text-color" style="line-height:1.6">Access streamlined workflows and instant data processing to accelerate your team's productivity and reduce time-to-market.</p>
            <!-- /wp:paragraph -->
        </div>
        <!-- /wp:group -->
    </div>
