 ...
 * Slug: auctor/services-feature-cards
...
<h3 class="wp-block-heading has-base-color has-text-color" style="font-size:1.5rem;font-weight:600">Consulting</h3>
<!-- /wp:heading -->

<!-- wp:image {"width":"40px","height":"40px","sizeSlug":"full","linkDestination":"none"} -->
<figure class="wp-block-image size-full is-resized"><img src="http://thaiconomics.test/app/themes/auctor/patterns/images/arrow-circle-filled.svg" alt="Arrow" style="width:40px;height:40px"/></figure>
<!-- /wp:image --></div>
<!-- /wp:group -->

<!-- wp:paragraph {"style":{"typography":{"lineHeight":"1.5"}},"textColor":"base"} -->
<p class="has-base-color has-text-color" style="line-height:1.5">Strategic guidance and expert advice to help your business grow, optimize processes, and achieve your goals with proven methodologies.</p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
...
<p class="has-base-color has-text-color" style="font-style:normal;font-weight:500">Strategy Planning</p>
<!-- /wp:paragraph -->

<!-- wp:image {"width":"40px","height":"40px","sizeSlug":"full","linkDestination":"none"} -->
<figure class="wp-block-image size-full is-resized"><img src="http://thaiconomics.test/app/themes/auctor/patterns/images/arrow-circle-filled-dark.svg" alt="Arrow" style="width:40px;height:40px"/></figure>
<!-- /wp:image --></div>
<!-- /wp:group -->
...
<p class="has-base-color has-text-color" style="font-style:normal;font-weight:500">Business Analysis</p>
<!-- /wp:paragraph -->
...
<div class="wp-block-group has-base-color has-ocean-blue-background-color has-text-color has-background" style="border-radius:12px;min-height:300px;padding-top:var(--wp--preset--spacing--large);padding-right:var(--wp--preset--spacing--large);padding-bottom:var(--wp--preset--spacing--large);padding-left:var(--wp--preset--spacing--large)"><!-- wp:group {"metadata":{"name":"Card Header"},"style":{"spacing":{"blockGap":"0"}},"layout":{"type":"flex","justifyContent":"space-between","verticalAlignment":"top"}} -->
<div class="wp-block-group"><!-- wp:heading {"level":3,"style":{"typography":{"fontSize":"1.5rem","fontWeight":"600"}},"textColor":"base"} -->
<h3 class="wp-block-heading has-base-color has-text-color" style="font-size:1.5rem;font-weight:600">Development</h3>
<!-- /wp:heading -->
...
<!-- wp:paragraph {"style":{"typography":{"lineHeight":"1.5"}},"textColor":"base"} -->
<p class="has-base-color has-text-color" style="line-height:1.5">Custom software solutions, web applications, and digital products built with modern technologies and best practices.</p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
...
<div class="wp-block-group"><!-- wp:group {"metadata":{"name":"Service Link"},"style":{"spacing":{"padding":{"top":"var:preset|spacing|small","bottom":"var:preset|spacing|small","left":"var:preset|spacing|small","right":"var:preset|spacing|small"},"blockGap":"0","margin":{"top":"var:preset|spacing|small","bottom":"var:preset|spacing|small"}},"border":{"radius":"8px","color":"var:preset|color|border-light","width":"1px"}},"backgroundColor":"dark-teal","textColor":"main","layout":{"type":"flex","justifyContent":"space-between","verticalAlignment":"center"}} -->
<div class="wp-block-group has-border-color has-main-color has-dark-teal-background-color has-text-color has-background" style="border-color:var(--wp--preset--color--border-light);border-width:1px;border-radius:8px;margin-top:var(--wp--preset--spacing--small);margin-bottom:var(--wp--preset--spacing--small);padding-top:var(--wp--preset--spacing--small);padding-right:var(--wp--preset--spacing--small);padding-bottom:var(--wp--preset--spacing--small);padding-left:var(--wp--preset--spacing--small)"><!-- wp:paragraph {"style":{"typography":{"fontWeight":"500","fontStyle":"normal"}},"textColor":"base"} -->
<p class="has-base-color has-text-color" style="font-style:normal;font-weight:500">Web Applications</p>
<!-- /wp:paragraph -->
...
<p class="has-base-color has-text-color" style="font-style:normal;font-weight:500">Mobile Apps</p>
<!-- /wp:paragraph -->
...
<div class="wp-block-group has-base-color has-ocean-blue-background-color has-text-color has-background" style="border-radius:12px;min-height:300px;padding-top:var(--wp--preset--spacing--large);padding-right:var(--wp--preset--spacing--large);padding-bottom:var(--wp--preset--spacing--large);padding-left:var(--wp--preset--spacing--large)"><!-- wp:group {"metadata":{"name":"Card Header"},"style":{"spacing":{"blockGap":"0"}},"layout":{"type":"flex","justifyContent":"space-between","verticalAlignment":"top"}} -->
<div class="wp-block-group"><!-- wp:heading {"level":3,"style":{"typography":{"fontSize":"1.5rem","fontWeight":"600"}},"textColor":"base"} -->
<h3 class="wp-block-heading has-base-color has-text-color" style="font-size:1.5rem;font-weight:600">Support</h3>
<!-- /wp:heading -->
...
<!-- wp:paragraph {"style":{"typography":{"lineHeight":"1.5"}},"textColor":"base"} -->
<p class="has-base-color has-text-color" style="line-height:1.5">Ongoing maintenance, technical support, and optimization services to keep your systems running smoothly and efficiently.</p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
...
<p class="has-base-color has-text-color" style="font-style:normal;font-weight:500">Maintenance</p>
<!-- /wp:paragraph -->
...
<p class="has-base-color has-text-color has-link-color" style="font-style:normal;font-weight:500">Technical Support</p>
<!-- /wp:paragraph -->
