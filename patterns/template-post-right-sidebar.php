 ...
 * Slug: auctor/template-post-right-sidebar
 * Template Types: single
 * Description: A post layout with a right sidebar and left content area.
...
<!-- wp:column {"width":"33.33%","className":"ollie-hide-on-mobile"} -->
