 ...
 * Slug: auctor/text-and-image-columns-with-testimonial
 * Description:
 * Categories: auctor/features, auctor/testimonial
...
<div class="wp-block-column is-vertically-aligned-center"><!-- wp:cover {"url":"<?php echo esc_url( get_template_directory_uri() ); ?>/patterns/images/guy-laptop.webp","id":2843,"dimRatio":0,"customOverlayColor":"#dddddb","isUserOverlayColor":true,"minHeightUnit":"px","isDark":false,"className":"is-style-rounded-cover","style":{"color":{"duotone":["#5344F4","#DDDAFB"]},"dimensions":{"aspectRatio":"1"}}} -->
<div class="wp-block-cover is-light is-style-rounded-cover"><span aria-hidden="true" class="wp-block-cover__background has-background-dim-0 has-background-dim" style="background-color:#dddddb"></span><img class="wp-block-cover__image-background wp-image-2843" alt="" src="<?php echo esc_url( get_template_directory_uri() ); ?>/patterns/images/guy-laptop.webp" data-object-fit="cover"/><div class="wp-block-cover__inner-container"><!-- wp:paragraph {"align":"center","placeholder":"Write title…"} -->
...
<!-- wp:heading -->
<h2 class="wp-block-heading">Auctor is built for the new WordPress Site Editor</h2>
<!-- /wp:heading -->

<!-- wp:paragraph -->
<p>Did you know you can build a blazing-fast, fully-customizable website with the native WordPress editor now? Download the Auctor block theme to start learning the new WordPress today!</p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
