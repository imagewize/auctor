 ...
 * Slug: auctor/contact-details
 * Description: Contact details with call to action buttons and a testimonial
 * Categories: auctor/testimonial, auctor/call-to-action, auctor/hero
 ...
 */
?>
<!-- wp:group {"metadata":{"name":"Contact Details"},"align":"full","style":{"spacing":{"margin":{"top":"0px","bottom":"0px"},"padding":{"top":"var:preset|spacing|xxx-large","bottom":"var:preset|spacing|xxx-large","right":"var:preset|spacing|medium","left":"var:preset|spacing|medium"}}},"layout":{"inherit":true,"type":"constrained"}} -->
...
<p class="has-primary-color has-text-color has-small-font-size" style="font-style:normal;font-weight:500">Contact Us</p>
<!-- /wp:paragraph -->

<!-- wp:heading -->
<h2 class="wp-block-heading">Give us a ring, we'd love to chat with you.</h2>
<!-- /wp:heading -->

<!-- wp:paragraph -->
<p>Whether you're looking for a brand refresh, a new web presence, or are curious about consultation, please drop us a line and let's start a blossoming relationship!</p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
...
<div class="wp-block-button is-style-secondary-button"><a class="wp-block-button__link wp-element-button">Join Our Team</a></div>
<!-- /wp:button --></div>
<!-- /wp:buttons -->
...
<p class="has-secondary-color has-text-color has-x-small-font-size" style="font-style:normal;font-weight:500">Rated 5/5 stars by 1,620 happy reviewers</p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:column -->
