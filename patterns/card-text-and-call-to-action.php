 ...
 * Slug: auctor/card-text-and-call-to-action
 * Description:
 * Categories: auctor/testimonial, auctor/hero, auctor/card, auctor/call-to-action
 ...
 */
?>
<!-- wp:group {"metadata":{"name":"Text and Call To Action Card"},"align":"full","style":{"spacing":{"padding":{"top":"var:preset|spacing|xxx-large","bottom":"var:preset|spacing|xxx-large","right":"var:preset|spacing|medium","left":"var:preset|spacing|medium"},"margin":{"top":"0","bottom":"0"}}},"backgroundColor":"tertiary","layout":{"type":"constrained"}} -->
...
<p class="has-primary-color has-text-color has-small-font-size" style="font-style:normal;font-weight:500">Explore Auctor</p>
<!-- /wp:paragraph -->

<!-- wp:heading -->
<h2 class="wp-block-heading">Publish with ease. No code required.</h2>
<!-- /wp:heading -->

<!-- wp:paragraph -->
<p>Auctor is a publishing theme for writers, editors, and content creators. With beautiful patterns and templates built right in, you can get your publication launched in record time.</p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
...
<p style="font-style:normal;font-weight:600">“Publishing with Auctor has transformed our editorial workflow.”</p>
<!-- /wp:paragraph -->
...
<p class="has-base-color has-text-color">Create compelling publications with the WordPress Site Editor and the Auctor publishing theme. Perfect for writers and publishers. No coding skills required.</p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
