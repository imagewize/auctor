 ...
 * Slug: auctor/hero-text-image-and-logos
 * Description:
...
<p class="has-text-align-center has-primary-color has-text-color" style="font-style:normal;font-weight:500">Welcome to Auctor</p>
<!-- /wp:paragraph -->

<!-- wp:heading {"textAlign":"center","fontSize":"x-large"} -->
<h2 class="wp-block-heading has-text-align-center has-x-large-font-size">Design faster and publish sooner with Auctor</h2>
<!-- /wp:heading -->

<!-- wp:paragraph {"align":"center","textColor":"secondary"} -->
<p class="has-text-align-center has-secondary-color has-text-color">Easily create compelling publications and editorial content with the new WordPress Site Editor and the Auctor block theme. No coding skills required.</p>
<!-- /wp:paragraph -->
